...
public abstract class AbstractButton extends Component {
    ...
    public static final String PROPERTY_DISABLED_CSS_CLASSES = "disabledCssClasses";
    public static final String PROPERTY_FOCUSED_CSS_CLASSES = "focusedCssClasses";
    public static final String PROPERTY_PRESSED_CSS_CLASSES = "pressedCssClasses";
    public static final String PROPERTY_ROLLOVER_CSS_CLASSES = "rolloverCssClasses";
